            ...
            flowSteps.forEach((step, index) => {
                ...
                if (arrow) {
                    ...
                    if (!arrowLengthCache.has(arrowPath)) {
                        ...
                        arrowLengthCache.set(arrowPath, length);
                    ...
                    if (arrowProgress > 0) {
                        ...
                        if (arrowHead) {
                            ...
                            const endPoint = arrowPath.getPointAtLength(totalLength);
                            const prevPoint = arrowPath.getPointAtLength(Math.max(totalLength - 1, 0));
                            const angle = Math.atan2(endPoint.y - prevPoint.y, endPoint.x - prevPoint.x) * (180 / Math.PI);

                            arrowHead.setAttribute('transform', `translate(${endPoint.x} ${endPoint.y}) rotate(${angle})`);
                        }
                    } else {
                        ...
                        if (arrowHead) {
                            ...
                            arrowHead.removeAttribute('transform');
                        }
                    }
                }
